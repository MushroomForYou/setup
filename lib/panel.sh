#!/bin/bash
# 3X-UI Panel installation and management
...
show_success() {
    ...
    echo -e "${GREEN}║${NC}  ${BOLD}${WHITE}${ICON_CHECK} INSTALLATION COMPLETE${NC}                                  ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}╠══════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_GLOBE} Domain:      ${YELLOW}$domain${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_SERVER} Server IP:   ${YELLOW}$ip${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_PLUG} Panel Port:  ${YELLOW}$port${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_KEY} Username:    ${YELLOW}$username${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_LOCK} Password:    ${YELLOW}$password${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_FOLDER} Web Path:    ${YELLOW}/$web_path${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_DB} Database:    ${YELLOW}$db_type (/etc/x-ui/x-ui.db)${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_ZAP} API Token:   ${YELLOW}${api_token:0:16}...${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}╠══════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_LOCK} SSL:         ${YELLOW}Let's Encrypt (auto-renewal enabled)${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_FOLDER} Cert Path:   ${YELLOW}$cert_path/${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_REFRESH} Auto-Renew:  ${YELLOW}Enabled (acme.sh cron job)${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}╠══════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}║${NC}  ${ICON_ROCKET} Access URL: ${YELLOW}https://$domain/$web_path${NC}"
    echo -e "${GREEN}║${NC}                                                              ${GREEN}║${NC}"
    echo -e "${GREEN}╚══════════════════════════════════════════════════════════════╝${NC}"
    echo ""
